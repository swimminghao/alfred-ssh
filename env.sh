...
printf $( getvar "bundleid" ) + "\n"
#printf $( getvar "version" )
#printf $( getvar "name" )
...
export alfred_workflow_data="${HOME}/Caches/com.runningwithcrayons.AlfredLibrary/Application Support/Alfred/Workflow Data/${alfred_workflow_bundleid}"
